#[test_only]
module floatsync::red_team_round_2_integer_abuse {
    use sui::test_scenario;
    use sui::coin;
    use sui::clock;
    use floatsync::merchant::{Self, MerchantAccount, MerchantRegistry};
    ...
    #[test]
    #[expected_failure(arithmetic_error, location = floatsync::merchant)]
